...
//// ============================================================================
//// FILE: Core/StoryManager.cs (UPDATED WITH ELEVATION TRACKING)
//// ============================================================================
//using ETABSv1;
//using System;
...
//                elevs[i] = storyHeights[i];  // Story HEIGHT (not elevation)
//                master[i] = (i == 0);
...
//                    $"Passing to ETABS: {elevs[i]:F3}");  // ← ADD THIS DEBUG LINE
